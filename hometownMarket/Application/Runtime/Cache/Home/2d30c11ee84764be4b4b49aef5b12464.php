		...
		<div class="col-lg-9 col-md-9 col-sm-12">
	         <div class="panel panel-default">
					  ...
					  <div class="panel-heading">
					    <h2 class="panel-title">查看我的商品</h2>
					  </div>
			        ...
			        <div class="tab-content">
			        	<div class="tab-pane active" id="sales">
				          	<table class="table  table-hover error">
				          		...
				          		<?php if(is_array($my_sale_goods_list["goods"])): foreach($my_sale_goods_list["goods"] as $key=>$ul): ?><tr>
										...
										<td><button data-toggle="modal" data-target="#deleteGoodsModal" type="button"  class="btn btn-default">删除</button></td>
									</tr>
									<!-- 删除商品按钮 -->
            					<div class="modal fade" id="deleteGoodsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					              <div class="modal-dialog">
					                <div class="modal-content">
					                  <div class="modal-header">
					                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					                  ...
					                  <div class="modal-footer">
					                    <button  type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					                    <button id="deleteGoodsbtn" type="button" class="btn btn-primary" >确认</button>
					                  </div>
					                </div>
					              </div>
					            </div>
					            <!-- 按钮结束 --><?php endforeach; endif; ?>
								<tfoot>
										<th colspan="6"><?php echo ($my_sale_goods_list["page"]); ?></th>
									</tfoot>
				          	</table>
			          	</div>
			          	<div class="tab-pane" id="purchase">
				          	<table class="table  table-hover error">
					          		...
					          		<?php if(is_array($my_purchase_goods_list["goods"])): foreach($my_purchase_goods_list["goods"] as $key=>$ul): ?><tr>
											<td ><a href="<?php echo U('Home/Goods/listGoods',array('secondgoods_id'=>$ul['secondgoods_id']));?>"><?php echo ($ul["secondgoods_name"]); ?></a></td>
											<td><?php echo ($ul["secondgoods_efficiency"]); ?></td>
											<td><?php echo (date("Y-m-d H:i",$ul["secondgoods_postdate"])); ?></td>
											<td><?php echo ($ul["secondgoods_views"]); ?></td>
									...
									<tfoot>
										<th colspan="6"><?php echo ($my_purchase_goods_list["page"]); ?></th>
									</tfoot>
					          	</table>
			          	</div>
