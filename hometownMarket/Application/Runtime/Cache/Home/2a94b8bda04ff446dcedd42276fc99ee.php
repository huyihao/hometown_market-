		  	...
		  	<div class="col-lg-9 col-md-9 col-xs-12">
			        ...
			        <div id="myCarousel" class="carousel slide bottom-margin">
			               ...
			               <ol class="carousel-indicators">
					        ...
					        <div class="carousel-inner">
					          ...
					          <?php if(is_array($newPic)): foreach($newPic as $key=>$ul): ?><div class="item">
			    	...
			    	<div class="">
			          <ul class="nav nav-tabs nav-justified" id="myTab">
			              ...
			              <?php if($_SESSION['userid'] != null): ?><li role="presentation"><a href="#menu"><?php echo ($_SESSION['username']); ?>,更多功能</a></li><?php endif; ?>
			          </ul>
			        <div class="tab-content">
			        	<div class="tab-pane active" id="sales">
			          	...
			          	<?php if($_SESSION['userid'] != null): ?><div class="tab-pane" id="menu">
								<div class="table-responsive">
								  <table class="table">
								    <tr><a href="<?php echo U('Home/Goods/listMyGoods');?>"><button  type="button" class="btn btn-default btn-lg">我的商品</button></a></tr>
								    <tr><a href=""><button  type="button" class="btn btn-default btn-lg">修改资料</button></a></tr>
								    <tr><a href="<?php echo U('Home/Message/receivebox');?>"><button type="button" class="btn btn-default btn-lg">收件箱</button></a></tr>
								    <tr><a href="<?php echo U('Home/Message/sendbox');?>"><button type="button" class="btn btn-default btn-lg">发件箱</button></a></tr>
								   	<tr><button data-toggle="modal" data-target="#functionModal" type="button" class="btn btn-default btn-lg">发送消息</button></tr>
								    <tr><a href="<?php echo U('Home/Index/logout');?>"><button type="button" class="btn btn-default btn-lg">退出系统</button></a></tr>
								  </table>
								<!-- 发送消息弹出框 -->
