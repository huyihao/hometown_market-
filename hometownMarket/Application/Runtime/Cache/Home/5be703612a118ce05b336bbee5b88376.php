			        ...
			        <div class="tab-content">
			        	<div class="tab-pane active" id="sales">
				          	<table class="table  table-hover error">
								...
								<tfoot>
										<th colspan="6"><?php echo ($sale_goods_list["page"]); ?></th>
									</tfoot>
				          	</table>
			          	</div>
			          	<div class="tab-pane" id="purchase">
				          	<table class="table  table-hover error">
					          		...
					          		<?php if(is_array($purchase_goods_list["goods"])): foreach($purchase_goods_list["goods"] as $key=>$ul): ?><tr>
											<td ><a href="<?php echo U('Home/Goods/listGoods',array('secondgoods_id'=>$ul['secondgoods_id']));?>"><?php echo ($ul["secondgoods_name"]); ?></a></td>
											<td><?php echo ($ul["secondgoods_efficiency"]); echo ($ul["secondgoods_id"]); ?></td>
											<td><?php echo (date("Y-m-d H:i:s",$ul["secondgoods_postdate"])); ?></td>
											<td><?php echo ($ul["secondgoods_views"]); ?></td>
										</tr><?php endforeach; endif; ?>
									<tfoot>
										<th colspan="6"><?php echo ($purchase_goods_list["page"]); ?></th>
									</tfoot>
					          	</table>
			          	</div>
